...
public class DailyStatsController {
	...
	@RequestMapping(value="/api/user/stats/daily", method=RequestMethod.GET)
	@ResponseStatus(HttpStatus.OK)
    public UserDailyStats getUserDailyStats(@RequestParam(required = false) Long id) 
		...
		UserDailyStats dailyStats = dailyStatsService.getDailyStats(user);
		return dailyStats;
